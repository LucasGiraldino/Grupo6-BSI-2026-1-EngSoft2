...
interface ConsultasCalendarGridProps {
  semanas: (number | null)[][]
  mesAtual: Date
  ...
  diaTemConsulta: (ano: number, mes: number, dia: number) => boolean
  diaEhPassado: (ano: number, mes: number, dia: number) => boolean
  selectDia: (chave: string | null) => void
}

export default function ConsultasCalendarGrid({
  semanas,
  mesAtual,
  carregandoMes,
  diaSelecionado,
